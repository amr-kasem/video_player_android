...
final class VideoPlayer {
    ...
    exoPlayer.addListener(
        new Listener() {
          ...
          public void onCues(CueGroup cueGroup) {
            // Combine the text of all cues into a single string and log it
            StringBuilder subtitleBuilder = new StringBuilder();
            for (Cue cue : cueGroup.cues) {
                if (cue.text != null) {
                    subtitleBuilder.append(cue.text).append("\n");
                }
            }
            String currentSubtitleText = subtitleBuilder.toString().trim();
            currentCue = currentSubtitleText;
            Log.w("amr event",currentCue);
          }
          @Override
          ...
          public void onTracksChanged(Tracks tracks) {
            for (Tracks.Group trackGroup : tracks.getGroups()) {
              ...
              for (int i = 0; i < trackGroup.length; i++) {
                ...
                Log.w("TrackSelectionLogger", trackFormat.toString() + (isSelected ? "True" : "False"));
              }
  ...
  String getCurrentSubtitleCue() {
    Log.w("amr request",currentCue);
    return currentCue;
  }
  ...
  void setTrackGroup(@NonNull Long arg1,@NonNull Long arg2) {
    final Tracks tracks = exoPlayer.getCurrentTracks();
        ...
        .setOverrideForType(
            new TrackSelectionOverride(
                tracks
                  .getGroups()
                  .get(arg1.intValue())
                  .getMediaTrackGroup(), /* trackIndex= */ arg2.intValue()))
        .build());
  }
