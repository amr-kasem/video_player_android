...
class TrackFormatMessage {
  ...
  static TrackFormatMessage decode(Object result) {
    result as List<Object?>;
    return TrackFormatMessage(
      textureId: result[0]! as int,
      id: result[1]! as String,
      label: result[2] as String?,
      language: result[3] as String?,
      formatIndex: result[4]! as int,
    );
  }
}
...
class TrackGroupMessage {
  ...
  static TrackGroupMessage decode(Object result) {
    result as List<Object?>;
    return TrackGroupMessage(
      textureId: result[0]! as int,
      adaptiveSupported: result[1]! as bool,
      trackSelected: (result[2] as List<Object?>?)!.cast<bool?>(),
      trackSupported: (result[3] as List<Object?>?)!.cast<bool?>(),
      formats: (result[4] as List<Object?>?)!.cast<TrackFormatMessage?>(),
      trackType: result[5]! as int,
      groupIndex: result[6]! as int,
    );
  }
}
...
class TracksMessage {
  ...
  static TracksMessage decode(Object result) {
    result as List<Object?>;
    return TracksMessage(
      textureId: result[0]! as int,
      groups: (result[1] as List<Object?>?)!.cast<TrackGroupMessage?>(),
    );
  }
}
...
class SubtitleMessage {
  ...
  static SubtitleMessage decode(Object result) {
    result as List<Object?>;
...
class TrackSelectionMessage {
  ...
  static TrackSelectionMessage decode(Object result) {
    result as List<Object?>;
    return TrackSelectionMessage(
      textureId: result[0]! as int,
      groupIndex: result[1]! as int,
      formatIndex: result[2]! as int,
    );
  }
}
...
class _AndroidVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CreateMessage) {
      ...
      buffer.putUint8(132);
      writeValue(buffer, value.encode());
    } else if (value is SubtitleMessage) {
      buffer.putUint8(133);
      writeValue(buffer, value.encode());
    } else if (value is TextureMessage) {
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
    } else if (value is TrackFormatMessage) {
      buffer.putUint8(135);
      writeValue(buffer, value.encode());
    } else if (value is TrackGroupMessage) {
      buffer.putUint8(136);
      writeValue(buffer, value.encode());
    } else if (value is TrackSelectionMessage) {
      buffer.putUint8(137);
      writeValue(buffer, value.encode());
    } else if (value is TracksMessage) {
      buffer.putUint8(138);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 133: 
        return SubtitleMessage.decode(readValue(buffer)!);
      case 134: 
        return TextureMessage.decode(readValue(buffer)!);
      case 135: 
        return TrackFormatMessage.decode(readValue(buffer)!);
      case 136: 
        return TrackGroupMessage.decode(readValue(buffer)!);
      case 137: 
        return TrackSelectionMessage.decode(readValue(buffer)!);
      case 138: 
        return TracksMessage.decode(readValue(buffer)!);
      case 139: 
...
class AndroidVideoPlayerApi {
  ...
  Future<TracksMessage> getTracks(TextureMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.getTracks', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_msg]) as List<Object?>?;
    if (replyList == null) {
      ...
      return (replyList[0] as TracksMessage?)!;
    }
  }

  Future<SubtitleMessage> getCurrentSubtitle(TextureMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.getCurrentSubtitle', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_msg]) as List<Object?>?;
    if (replyList == null) {
      ...
      return (replyList[0] as SubtitleMessage?)!;
    }
  }

  Future<void> setTrackGroup(TrackSelectionMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.setTrackGroup', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_msg]) as List<Object?>?;
    if (replyList == null) {
